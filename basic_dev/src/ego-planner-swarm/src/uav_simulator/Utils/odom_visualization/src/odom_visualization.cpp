...
void odom_callback(const nav_msgs::Odometry::ConstPtr& msg)
{
  ...
  poseROS.header.frame_id = string("camera_init");
  ...
  velROS.header.frame_id = string("camera_init");
  ...
  if (cov_pos)
  {
    ...
    covROS.header.frame_id = string("camera_init");
  ...
  if (cov_vel)
  {
    ...
    covVelROS.header.frame_id = string("camera_init");
  ...
  if ((t - pt).toSec() > 0.5)
  {
    trajROS.header.frame_id = string("camera_init");
  ...
  // Sensor availability
  sensorROS.header.frame_id = string("camera_init");
  ...
  if (tf45)
  {
    ...
    broadcaster->sendTransform(tf::StampedTransform(transform,   msg->header.stamp, string("camera_init"), base_s));      
...
int main(int argc, char** argv)
{
  ...
  n.param("frame_id",   _frame_id, string("camera_init") ); 
