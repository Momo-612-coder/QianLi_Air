#ifndef _PWM_MPC_CONTROLLER_HPP_
#define _PWM_MPC_CONTROLLER_HPP_
...
private:
    ...
    double mpc_solve_hz_ = 20.0;
    double max_state_age_sec_ = 0.2;
    ros::Timer command_timer_;

    MPC mpc_controller_;
    DM mixing_matrix_;
    std::vector<double> pwm_cmd_{0.0, 0.0, 0.0, 0.0};

public:
    PwmMpcController(ros::NodeHandle *nh);
    ~PwmMpcController();
